export default function Footer() {
    // #region agent log
    fetch('http://127.0.0.1:7840/ingest/783476b0-ecb3-43f0-b6aa-bc82e28b0e4a', { method: 'POST', headers: { 'Content-Type': 'application/json', 'X-Debug-Session-Id': 'b717b5' }, body: JSON.stringify({ sessionId: 'b717b5', runId: 'pre-debug', hypothesisId: 'H_footer_Link', location: 'src/pages/Home/components/Footer.jsx', message: 'Footer function invoked (before JSX)', data: {}, timestamp: Date.now() }) }).catch(() => {});
    // #endregion
    return (
